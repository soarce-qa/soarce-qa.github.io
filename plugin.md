...
Althought there will be security measures in place, include this library only as a --dev
...
Just call the index page of your application - e.g. `/` or `/index.php` and add `?SOARCE=index`
to the call.
